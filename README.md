## laser_proc (melodic) - 0.1.4-1

The packages in the `laser_proc` repository were released into the `melodic` distro by running `/usr/bin/bloom-release laser_proc -t melodic -r melodic --new-track` on `Thu, 09 Aug 2018 23:30:52 -0000`
